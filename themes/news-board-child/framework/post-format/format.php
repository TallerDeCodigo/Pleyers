...
<div class="row">
    <?php if ($large_image_url[0] != "") {?> <!--**********************WITH IMAGE****************************-->
    ...
    <?php } else {;?> <!--***********************************************NO IMAGE****************************-->
        <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="mes_full_blog_post_date">
                    <h4 class="mes_date_y colored"><?php the_time('d M') ?></h4>
                    <h2 class="mes_date_d"><?php the_time('Y') ?></h2>
                </div>
                <div class="mes_blog_full_content_holder" style="padding-left: 100px;padding-bottom: 20px;">
