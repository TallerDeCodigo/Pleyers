 ...
 */
add_action('widgets_init', 'Mestowabo_load_flickr_widgets');

function Mestowabo_load_flickr_widgets()
{
	register_widget('Mestowabo_Flickr_Widget');
}
 ...
 *
 */
	class Mestowabo_Flickr_Widget extends WP_Widget {

	/**
	 * Widget setup.
	 */		
	function Mestowabo_Flickr_Widget() {
		
		/* Widget settings. */
		$widget_ops = array('classname' => 'Mestowabo_flickr_widget', 'description' => __( 'Mestowabo: Flickr Widget', 'mestowabo' ) );

		/* Widget control settings. */
		$control_ops = array( 'width' => 200, 'height' => 350, 'id_base' => 'Mestowabo_flickr_widget' );

		/* Create the widget. */		
		$this->WP_Widget( 'Mestowabo_flickr_widget', 'Mestowabo: Flickr Widget ', $widget_ops);
	}
