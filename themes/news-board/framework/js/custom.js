...
var mesnum = $('#instafeed').data('numbers')
		    var feed = new Instafeed({
        		...
        		template: '<div class="col-lg-2 col-md-2 col-sm-3 col-xs-4 mes_insta_feed"><a href="{{link}}"><div class="mes_insta_overlay"><div class="mes-outer"><div class="mes-middle"><div class="mes-inner"><div class="mes_insta_likes"><i class="fa fa-heart"></i>{{likes}}</div><div class="mes_insta_comments"><i class="fa fa-comment"></i>{{comments}}</div></div></div></div></div><img alt="" src="{{image}}" /></div></a>',
...
//go to section
jQuery.noConflict()(function($){
	$('.mes_menu_content_holder > ul > li > a').click(function () {
		var $link = $(this).attr('href').substring(1);
		var $elem = $('body').find('.'+ $link);
		if($elem.length>0){
			$('html, body').animate({
        	scrollTop: $($elem).offset().top}, 800, function() {})
		}
...
//CART MOBILE MENU
jQuery.noConflict()(function($){
	$('.mes_cart_wrap').click(function () {
		$('.header_cart_widget').slideToggle(200)
	})
});


jQuery.noConflict()(function($){
	$('#mes_menu-toggle-wrapper').on( "click", function () {
		if($('#mes_menu-toggle-wrapper').hasClass('anim-out')){
			$('#mes_menu-toggle-wrapper').removeClass('anim-out')
			$('.mes_menu_content_holder').slideToggle(200)
		} else {
			$('#mes_menu-toggle-wrapper').addClass('anim-out')
			$('.mes_menu_content_holder').slideToggle(200)
		}
	});
